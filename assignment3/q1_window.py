...
class WindowModel(NERModel):
    ...
    def add_embedding(self):
        ...
        """
        pretrained_embeddings = tf.Variable(self.pretrained_embeddings, trainable=True)
    ...
    def add_prediction_op(self):
        ...
        self.W = tf.Variable(initializer([Config.n_window_features * Config.embed_size, Config.hidden_size]))
        self.b1 = tf.Variable(zero_initializer([Config.hidden_size]))
        self.U = tf.Variable(initializer([Config.hidden_size, Config.n_classes]))
        self.b2 = tf.Variable(zero_initializer([Config.n_classes]))
